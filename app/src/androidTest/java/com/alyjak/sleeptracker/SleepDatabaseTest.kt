package com.alyjak.sleeptracker
...
class SleepDatabaseTest {
    ...
    @Test
    @Throws(Exception::class)
    fun insertMoreThanOneAndGetNights() {
        val night1 = SleepNight(nightId = 1L)
        val night2 = SleepNight(nightId = 2L)
        val night3 = SleepNight(nightId = 3L)
        sleepDao.insert(night1)
        sleepDao.insert(night2)
        sleepDao.insert(night3)
        val tonight = sleepDao.getTonight()
        assertEquals(tonight?.nightId, 3L)
    }
